...
from env_runner.sim_runner_X import RobotRunner
...
def evaluate(args):
    ...
    env_runner = RobotRunner(n_obs_steps=args.num_obs, 
    ...
    save_dir = Path(f"{RoboTwin_ROOT}/eval_result_X/{task_name}/{policy_name}/{task_config}/{ckpt_setting}/{current_time}{args.extra_info}")
...
def args_parser():
    ...
    parser.add_argument('--policy_name', action = 'store', type = str, help = 'policy name', required = False, default='XRISE')
