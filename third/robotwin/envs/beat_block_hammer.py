...
class beat_block_hammer(Base_Task):
    ...
    def setup_demo(self, **kwags):
        ...
        # add
        self.target_obj1 = self.hammer
        self.target_obj2 = self.block
        self.target_obj3 = None
    ...
    def play_once(self):
        # Get the position of the block's functional point --> 0号功能点应该是在挨着桌面的bottom面上，1号功能点应该是在top面上供与其它物体交互。
