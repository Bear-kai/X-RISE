...
- For training only, please follow the [installation guide](https://github.com/rise-policy/RISE/blob/main/assets/docs/INSTALL.md) of RISE to install the `rise` conda environment , since our X-RISE is based on RISE.

- For training and evaluation on [RoboTwin 2.0](https://github.com/robotwin-Platform/RoboTwin) benchmark, please follow the [installation guide](https://robotwin-platform.github.io/doc/usage/robotwin-install.html) to install the `robotwin` conda environment. Clone this repository and put it under the `RoboTwin/policy/` directory. Use the files in `third/robotwin` to replace the corresponding files in the cloned robotwin repository (run `replace_files.py` in X-RISE directory). Activate `robotwin` environment and install the necessary dependencies of RISE. 

- Notes: For training and evaluation on RoboTwin 2.0, we have tested on `Ubuntu 22.04` + `CUDA 12.1` + `python 3.10` + `torch 2.3.0`. For training only, we have additionally tested on `Ubuntu 18.04` + `CUDA 11.8` + `python 3.8` + `torch 2.4.1`. During our last test, the commit ID of robotwin repository was `ea25643210c3036e57eb44b4cd4b59b8dc1e98d7`.
...
Since RISE is licensed under <a href="https://creativecommons.org/licenses/by-nc-sa/4.0/?ref=chooser-v1" target="_blank" rel="license noopener noreferrer" style="display:inline-block;">CC BY-NC-SA 4.0<img style="height:22px!important;margin-left:3px;vertical-align:text-bottom;" src="https://mirrors.creativecommons.org/presskit/icons/cc.svg?ref=chooser-v1" alt=""><img style="height:22px!important;margin-left:3px;vertical-align:text-bottom;" src="https://mirrors.creativecommons.org/presskit/icons/by.svg?ref=chooser-v1" alt=""><img style="height:22px!important;margin-left:3px;vertical-align:text-bottom;" src="https://mirrors.creativecommons.org/presskit/icons/nc.svg?ref=chooser-v1" alt=""><img style="height:22px!important;margin-left:3px;vertical-align:text-bottom;" src="https://mirrors.creativecommons.org/presskit/icons/sa.svg?ref=chooser-v1" alt=""></a>. We have to follow the same license for X-RISE.